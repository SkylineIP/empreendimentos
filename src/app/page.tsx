...
const Home: React.FC = () => {
  ...
  return (
    <div className="w-fulll h-screen bg-[#2824B4] min-w-[800px] min-h-[600px] ">
    {openSkyline ? (<div className="w-full h-full flex justify-evenly bg-[#B29A83] bg-[url(/tela-descanso.png)] bg-cover bg-center bg-no-repeat animate-fade-right cursor-pointer" onClick={handleClick}>
    ...
    </div>): (<Image src="/skyline.png" className="animate-fade-up animate-duration-[3000ms] bg-[#2824B4] " alt="Skyline, inovação e produções" fill />)}
    </div>
  );
};
