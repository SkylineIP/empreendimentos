...
const arrayNomesBotoes = [
  {
    ...
    subBtn: [
      ...
      { title: "TOUR VIRTUAL", caminho: "101m-tour", legenda: "legenda-3" },
    ],
    caminho: "101m-padrao",
    legenda: "legenda-1",
  },
  {
    ...
    subBtn: [
      ...
      { title: "TOUR VIRTUAL", caminho: "122m-tour", legenda: "legenda-7" },
    ],
    caminho: "122m-padrao",
    legenda: "legenda-4",
  },
  {
    ...
    subBtn: [
      ...
      { title: "TOUR VIRTUAL", caminho: "150m-tour", legenda: "legenda-12" },
    ],
    caminho: "150m-padrao",
    legenda: "legenda-8",
  },
